...
public class BlockEntityTester extends BlockContainer
{
    ...
    {
        return new TileEntityEntityTester();
    }
    ...
    {
        TileEntity tileentity = worldIn.getTileEntity(pos);
        return tileentity instanceof TileEntityEntityTester ? ((TileEntityEntityTester) tileentity).count : 0;
    }
	...
	public void addInformation(ItemStack stack, World world, List<String> list, ITooltipFlag flag)
	{
		...
		list.add(Translator.translate("lore.custombgm.entity_tester"));
