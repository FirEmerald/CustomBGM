...
public class BaseMusicProvider extends BGMProvider
{
	...
	public static BaseMusicProvider serialize(JsonObject json, int priority, Predicate<Player> condition, ICondition.IContext conditionContext)
	{
	...
	public BaseMusicProvider(int priority, Predicate<Player> condition, IDistribution<ResourceLocation> tracks)
	{
	...
	@Override
	public ResourceLocation getTheMusic(Player player, @Nullable ResourceLocation currentMusic)
	{
		return pickOne(player.getRandom(), currentMusic, tracks);
	}
}