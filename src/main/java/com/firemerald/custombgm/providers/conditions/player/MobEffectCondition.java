...
public record MobEffectCondition(MobEffect effect, MinMaxBounds.Ints amplifier, MinMaxBounds.Ints duration, Optional<Boolean> ambient, Optional<Boolean> visible) implements BGMProviderPlayerCondition {
	public static final MapCodec<MobEffectCondition> CODEC = RecordCodecBuilder.mapCodec(instance ->
		instance.group(
				CustomBGMCodecs.MOB_EFFECT.fieldOf("effect").forGetter(MobEffectCondition::effect),
				Codecs.INT_BOUNDS.optionalFieldOf("amplifier", MinMaxBounds.Ints.ANY).forGetter(MobEffectCondition::amplifier),
				Codecs.INT_BOUNDS.optionalFieldOf("duration", MinMaxBounds.Ints.ANY).forGetter(MobEffectCondition::duration),
