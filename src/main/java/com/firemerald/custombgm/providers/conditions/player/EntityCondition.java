...
public record EntityCondition(EntityPredicate predicate) implements BGMProviderCondition {
	public static final MapCodec<EntityCondition> CODEC = CustomBGMCodecs.ENTITY_PREDICATE.xmap(EntityCondition::new, EntityCondition::predicate).fieldOf("predicate");
