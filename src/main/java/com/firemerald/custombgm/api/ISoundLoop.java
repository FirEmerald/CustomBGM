...
public interface ISoundLoop
{
	 ...
	 * @return the volume
	 */
	public static float getCategoryVolume(SoundSource category)
	{
		return category == SoundSource.MASTER ? 1 : Minecraft.getInstance().options.getSoundSourceVolume(category);
	}
}