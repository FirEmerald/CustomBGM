...
public interface BGMProviderCondition extends Predicate<PlayerConditionData> {
    public static final Codec<BGMProviderCondition> CODEC = Codecs.byNameCodec(CustomBGMRegistries.conditionCodecs).dispatch(BGMProviderCondition::codec, MapCodec::codec);
